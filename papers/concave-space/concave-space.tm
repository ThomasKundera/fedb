...
<\body>
  ...
  altitude (see Figure <reference|fig1>).
  ...
  <big-figure|<image|images/Picture_taken_at_aprox._100,000_feet_above_Oregon_by_Justin_Hamel_and_Chris_Thompson.jpg|14cm|||>|
  <label|fig1> Picture taken at approximately 30 km above Oregon, United
  State, by Justin Hamel and Chris Thomson (source Wikimedia Common)|>
  ...
  Resulting plot is at Figure <reference|fig3>.

  <\big-figure|<image|code/python/incidence.eps|16cm|||>>
    <label|fig3>
  </big-figure>
